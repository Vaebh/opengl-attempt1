#include "AnimatedSprite.h"
	...
	AnimatedSprite::AnimatedSprite(const std::string inTexture, int inNumFrames, float inAnimationSpeed) : Sprite(inTexture), mAnimSpeed(inAnimationSpeed), mNumFrames(inNumFrames), mCurrentFrame(0)
   {
     SendAnimInfo();
   }
