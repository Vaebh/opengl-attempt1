...
namespace FMOD
{
    ...
    */
    ...
    public enum INITFLAGS :int
    {
        ...
        MIX_FROM_UPDATE           = 0x00000002, /* Win32/Wii/PS3/Xbox/Xbox 360 Only - FMOD Mixer thread is woken up to do a mix when System::update is called rather than waking periodically on its own timer. */
        ...
        CHANNEL_DISTANCEFILTER    = 0x00000400, /* All FMOD_3D based voices will add a software lowpass and highpass filter effect into the DSP chain which will act as a distance-automated bandpass filter. Use System::setAdvancedSettings to adjust the center frequency. */
    ...
    */
    public enum CHANNELCONTROL_DSP_INDEX :int
    {
        HEAD     = -1,      /* Head of the DSP chain. */
        FADER    = -2,      /* Built in fader DSP. */
        PANNER   = -3,      /* Built in panner DSP. */
        TAIL     = -4,      /* Tail of the DSP chain. */
    }
    ...
    /* 
        FMOD Callbacks
    */
    public delegate RESULT SYSTEM_CALLBACK          (IntPtr systemraw, SYSTEM_CALLBACKTYPE type, IntPtr commanddata1, IntPtr commanddata2, IntPtr userdata);
    ...
    */
    ...
    public struct TAG
    {
        ...
        public IntPtr            namePtr;      /* [r] The name of this tag i.e. "TITLE", "ARTIST" etc. */
    ...
    */
    ...
    public struct CREATESOUNDEXINFO
    {
        ...
        public string                      dlsname;                /* [w] Optional. Specify 0 to ignore. Filename for a DLS or SF2 sample set when loading a MIDI file.   If not specified, on windows it will attempt to open /windows/system32/drivers/gm.dls, otherwise the MIDI will fail to open.  */
        public string                      encryptionkey;          /* [w] Optional. Specify 0 to ignore. Key for encrypted FSB file.  Without this key an encrypted FSB file will not load. */
    ...
    */
    ...
    {
        RESULT                      result;                     /* Error code result */
        ERRORCALLBACK_INSTANCETYPE  instancetype;               /* Type of instance the error occurred on */
        IntPtr                      instance;                   /* Instance pointer */
        IntPtr                      functionname;               /* Function that the error occurred on */
        IntPtr                      functionparams;             /* Function parameters that the error ocurred on */
    }
    ...
    */
    public class System
    {
        ...
        {
            return FMOD_System_SetSoftwareFormat(systemraw, samplerate, speakermode, numrawspeakers);
        }
        ...
        {
            return FMOD_System_SetPluginPath(systemraw, Encoding.UTF8.GetBytes(path + Char.MinValue));
        }
        public RESULT loadPlugin             (string filename, ref uint handle, uint priority)
        {
            return FMOD_System_LoadPlugin(systemraw, Encoding.UTF8.GetBytes(filename + Char.MinValue), ref handle, priority);
        }
        ...
        public RESULT createDSPByPlugin(uint handle, ref DSP dsp)
        {
            RESULT result = RESULT.OK;
            ...
            try
            {
                result = FMOD_System_CreateDSPByPlugin(systemraw, handle, ref dspraw);
            }
            catch
            {
        ...
        {
            return FMOD_System_SetSpeakerPosition(systemraw, speaker, x, y, (active ? 1 : 0));
        }
        public RESULT getSpeakerPosition     (SPEAKER speaker, ref float x, ref float y, ref bool active)
        {
            RESULT result;
            
            int isactive = 0;

            result = FMOD_System_GetSpeakerPosition(systemraw, speaker, ref x, ref y, ref isactive);
        ...
        public RESULT createSound            (string name, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            RESULT result           = RESULT.OK;
            ...
            try
            {
                result = FMOD_System_CreateSound(systemraw, stringData, mode, ref exinfo, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createSound            (string name, MODE mode, ref Sound sound)
        {
            RESULT result           = RESULT.OK;
            IntPtr      soundraw    = new IntPtr();
            Sound       soundnew    = null;
            ...
            try
            {
                result = FMOD_System_CreateSound(systemraw, stringData, mode, 0, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return FMOD_System_SetReverbProperties(systemraw, instance, ref prop);
        }
        public RESULT getReverbProperties    (int instance, ref REVERB_PROPERTIES prop)
        {
        ...
        {
            return FMOD_System_SetNetworkProxy(systemraw, Encoding.UTF8.GetBytes(proxy + Char.MinValue));
        }
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_LoadPlugin             (IntPtr system, byte[] filename, ref uint handle, uint priority);
        [DllImport (VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_System_SetSpeakerPosition     (IntPtr system, SPEAKER speaker, float x, float y, int active);
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_GetSpeakerPosition     (IntPtr system, SPEAKER speaker, ref float x, ref float y, ref int active);
        [DllImport (VERSION.dll)]                       
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_CreateChannelGroup     (IntPtr system, byte[] name, ref IntPtr channelgroup);
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_CreateSoundGroup       (IntPtr system, byte[] name, ref IntPtr soundgroup);
        [DllImport (VERSION.dll)]
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_GetReverbProperties    (IntPtr system, int instance, ref REVERB_PROPERTIES prop);
        [DllImport (VERSION.dll)]
    ...
    */
    public class ChannelControl
    {
        public RESULT getSystemObject(ref System system)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_GetSystemObject(rawPtr, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return FMOD_ChannelGroup_SetPaused(rawPtr, (paused ? 1 : 0));
        }
        public RESULT getPaused(ref bool paused)
        {
            ...
            result = FMOD_ChannelGroup_GetPaused(rawPtr, ref p);
        ...
        {
            return FMOD_ChannelGroup_GetVolume(rawPtr, ref volume);
        }
        ...
        {
            return FMOD_ChannelGroup_GetPitch(rawPtr, ref pitch);
        }
        public RESULT setMute(bool mute)
        {
            return FMOD_ChannelGroup_SetMute(rawPtr, (mute ? 1 : 0));
        }
        public RESULT getMute(ref bool mute)
        {
            ...
            result = FMOD_ChannelGroup_GetMute(rawPtr, ref m);
        ...
        public RESULT getReverbProperties(int instance, ref float wet)
        {
            return FMOD_ChannelGroup_GetReverbProperties(rawPtr, instance, ref wet);
        }
        ...
        {
            return FMOD_ChannelGroup_GetLowPassGain(rawPtr, ref gain);
        }
        ...
        public RESULT isPlaying(ref bool isplaying)
        {
            ...
            result = FMOD_ChannelGroup_IsPlaying(rawPtr, ref p);
        ...
        {
            return FMOD_ChannelGroup_SetDelay(rawPtr, dspclock_start, dspclock_end, stopchannels ? 1 : 0);
        }
        public RESULT getDelay(out ulong dspclock_start, out ulong dspclock_end, out bool stopchannels)
        {
            int temp;

            RESULT result = FMOD_ChannelGroup_GetDelay(rawPtr, out dspclock_start, out dspclock_end, out temp);
        ...
        {
            DSPConnection temp = null;
            return addDSP(dsp, CHANNELCONTROL_DSP_INDEX.HEAD, ref temp);
        }
        public RESULT addDSP(DSP dsp, CHANNELCONTROL_DSP_INDEX index, ref DSPConnection connection)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_AddDSP(rawPtr, index, dsp.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return FMOD_ChannelGroup_Get3DMinMaxDistance(rawPtr, ref mindistance, ref maxdistance);
        }
        public RESULT set3DConeSettings(float insideconeangle, float outsideconeangle, float outsidevolume)
        {
        ...
        public RESULT get3DConeSettings(ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume)
        {
            return FMOD_ChannelGroup_Get3DConeSettings(rawPtr, ref insideconeangle, ref outsideconeangle, ref outsidevolume);
        }
        ...
        {
            return FMOD_ChannelGroup_Get3DConeOrientation(rawPtr, ref orientation);
        }
        public RESULT set3DCustomRolloff(ref VECTOR points, int numpoints)
        {
        ...
        public RESULT get3DCustomRolloff(ref IntPtr points, ref int numpoints)
        {
            return FMOD_ChannelGroup_Get3DCustomRolloff(rawPtr, ref points, ref numpoints);
        }
        ...
        {
            return FMOD_ChannelGroup_Get3DOcclusion(rawPtr, ref directocclusion, ref reverbocclusion);
        }
        ...
        {
            return FMOD_ChannelGroup_Get3DSpread(rawPtr, ref angle);
        }
        ...
        {
            return FMOD_ChannelGroup_Get3DDopplerLevel(rawPtr, ref level);
        }
        public RESULT set3DDistanceFilter(bool custom, float customLevel, float centerFreq)
        {
            return FMOD_ChannelGroup_Set3DDistanceFilter(rawPtr, custom ? 1 : 0, customLevel, centerFreq);
        }
        public RESULT get3DDistanceFilter(out bool custom, out float customLevel, out float centerFreq)
        {
            int temp;

            RESULT result = FMOD_ChannelGroup_Get3DDistanceFilter(rawPtr, out temp, out customLevel, out centerFreq);
        ...
        public RESULT getUserData(ref IntPtr userdata)
        {
            return FMOD_ChannelGroup_GetUserData(rawPtr, ref userdata);
        }
        public RESULT setVolumeRamp(bool ramp)
        {
            return FMOD_ChannelGroup_SetVolumeRamp(rawPtr, ramp ? 1 : 0);
        }
        public RESULT getVolumeRamp(out bool ramp)
        {
            int temp;

            RESULT result = FMOD_ChannelGroup_GetVolumeRamp(rawPtr, out temp);
        ...
        {
            return FMOD_ChannelGroup_GetAudibility(rawPtr, ref audibility);
        }
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetDelay(IntPtr channelgroup, ulong dspclock_start, ulong dspclock_end, int stopchannels);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_GetDelay(IntPtr channelgroup, out ulong dspclock_start, out ulong dspclock_end, out int stopchannels);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DMinMaxDistance(IntPtr channelgroup, ref float mindistance, ref float maxdistance);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DConeSettings(IntPtr channelgroup, ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Set3DConeOrientation(IntPtr channelgroup, ref VECTOR orientation);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DConeOrientation(IntPtr channelgroup, ref VECTOR orientation);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Set3DCustomRolloff(IntPtr channelgroup, ref VECTOR points, int numpoints);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DCustomRolloff(IntPtr channelgroup, ref IntPtr points, ref int numpoints);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DSpread(IntPtr channelgroup, ref float angle);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DDopplerLevel(IntPtr channelgroup, ref float level);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Set3DDistanceFilter(IntPtr channelgroup, int custom, float customLevel, float centerFreq);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_Get3DDistanceFilter(IntPtr channelgroup, out int custom, out float customLevel, out float centerFreq);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetReverbProperties(IntPtr channelgroup, int instance, float wet);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_GetReverbProperties(IntPtr channelgroup, int instance, ref float wet);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetLowPassGain(IntPtr channelgroup, float gain);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_GetLowPassGain(IntPtr channelgroup, ref float gain);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_IsPlaying(IntPtr channelgroup, ref int isplaying);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetVolumeRamp(IntPtr channelgroup, int ramp);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_GetVolumeRamp(IntPtr channelgroup, out int ramp);
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_GetAudibility(IntPtr channelgroup, ref float audibility);
        [DllImport(VERSION.dll)]
        ...
        public void setRaw(IntPtr channelcontrol)
        {
            rawPtr = new IntPtr();

            rawPtr = channelcontrol;
        }
    ...
    */
    public class Channel : ChannelControl
    {
        ...
        {
            return FMOD_Channel_GetFrequency(getRaw(), ref frequency);
        }
        ...
        {
            return FMOD_Channel_SetSpeakerMix(getRaw(), frontleft, frontright, center, lfe, backleft, backright, sideleft, sideright);
        }
        ...
        {
            return FMOD_Channel_GetSpeakerMix(getRaw(), ref frontleft, ref frontright, ref center, ref lfe, ref backleft, ref backright, ref sideleft, ref sideright);
        }
        public RESULT setSpeakerLevels      (SPEAKER speaker, float[] levels, int numlevels)
        {
            return FMOD_Channel_SetSpeakerLevels(getRaw(), speaker, levels, numlevels);
        }
        ...
        {
            return FMOD_Channel_SetInputChannelMix(getRaw(), levels, numlevels);
        }
        public RESULT getInputChannelMix    (float[] levels, int numlevels)
        {
            return FMOD_Channel_GetInputChannelMix(getRaw(), levels, numlevels);
        }
        ...
        {
            return FMOD_Channel_GetPriority(getRaw(), ref priority);
        }
        ...
        {
            return FMOD_Channel_GetPosition(getRaw(), ref position, postype);
        }
        ...
        public RESULT getChannelGroup       (ref ChannelGroup channelgroup)
        {
            ...
            try
            {
                result = FMOD_Channel_GetChannelGroup(getRaw(), ref channelgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return FMOD_Channel_Set3DPanLevel(getRaw(), level);
        }
        public RESULT get3DPanLevel         (ref float level)
        {
            return FMOD_Channel_Get3DPanLevel(getRaw(), ref level);
        }
        public RESULT isVirtual             (ref bool isvirtual)
        {
            ...
            result = FMOD_Channel_IsVirtual(getRaw(), ref v);
        ...
        public RESULT getCurrentSound       (ref Sound sound)
        {
            ...
            try
            {
                result = FMOD_Channel_GetCurrentSound(getRaw(), ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getSpectrum           (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            return FMOD_Channel_GetSpectrum(getRaw(), spectrumarray, numvalues, channeloffset, windowtype);
        }
        public RESULT getWaveData           (float[] wavearray, int numvalues, int channeloffset)
        {
            return FMOD_Channel_GetWaveData(getRaw(), wavearray, numvalues, channeloffset);
        }
        public RESULT getIndex              (ref int index)
        {
            return FMOD_Channel_GetIndex(getRaw(), ref index);
        }
        ...
        public RESULT getDSPHead            (ref DSP dsp)
        {
            ...
            try
            {
                result = FMOD_Channel_GetDSPHead(getRaw(), ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getMode               (ref MODE mode)
        {
            return FMOD_Channel_GetMode(getRaw(), ref mode);
        }
        public RESULT setLoopCount          (int loopcount)
        {
        ...
        public RESULT getLoopCount          (ref int loopcount)
        {
            return FMOD_Channel_GetLoopCount(getRaw(), ref loopcount);
        }
        public RESULT setLoopPoints         (uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype)
        {
        ...
        public RESULT getLoopPoints         (ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype)
        {
            return FMOD_Channel_GetLoopPoints(getRaw(), ref loopstart, loopstarttype, ref loopend, loopendtype);
        }
    ...
    */
    public class ChannelGroup : ChannelControl
    {
        ...
        {
            return FMOD_ChannelGroup_GetNumGroups(getRaw(), ref numgroups);
        }
        public RESULT getGroup               (int index, ref ChannelGroup group)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_GetGroup(getRaw(), index, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getParentGroup         (ref ChannelGroup group)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_GetParentGroup(getRaw(), ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getDSPHead             (ref DSP dsp)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_GetDSPHead(getRaw(), ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return FMOD_ChannelGroup_GetNumChannels(getRaw(), ref numchannels);
        }
        public RESULT getChannel             (int index, ref Channel channel)
        {
            ...
            try
            {
                result = FMOD_ChannelGroup_GetChannel(getRaw(), index, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getSpectrum            (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            return FMOD_ChannelGroup_GetSpectrum(getRaw(), spectrumarray, numvalues, channeloffset, windowtype);
        }
        public RESULT getWaveData            (float[] wavearray, int numvalues, int channeloffset)
        {
            return FMOD_ChannelGroup_GetWaveData(getRaw(), wavearray, numvalues, channeloffset);
        }
    ...
    */
    public class DSP
    {
        ...
        {
            return FMOD_DSP_SetParameterFloat(dspraw, index, value);
        }
        public RESULT setParameterInt(int index, int value)
        {
            return FMOD_DSP_SetParameterInt(dspraw, index, value);
        }
        public RESULT setParameterBool(int index, bool value)
        {
            return FMOD_DSP_SetParameterBool(dspraw, index, value ? 1 : 0);
        }
        public RESULT setParameterData(int index, byte[] data)
        {
            return FMOD_DSP_SetParameterData(dspraw, index, Marshal.UnsafeAddrOfPinnedArrayElement(data, 0), (uint)data.Length);
        }
        public RESULT getParameterFloat(int index, out float value)
        {
            StringBuilder valuestr = null;
            return FMOD_DSP_GetParameterFloat(dspraw, index, out value, valuestr, 0);
        }
        public RESULT getParameterInt(int index, out int value)
        {
            StringBuilder valuestr = null;
            return FMOD_DSP_GetParameterInt(dspraw, index, out value, valuestr, 0);
        }
        public RESULT getParameterBool(int index, out bool value)
        {
            int iValue = 0;
            StringBuilder valuestr = null;
            RESULT result = FMOD_DSP_GetParameterBool(dspraw, index, out iValue, valuestr, 0);
            value = (iValue != 0);
        ...
        {
            StringBuilder valuestr = null;
            return FMOD_DSP_GetParameterData(dspraw, index, out data, out length, valuestr, 0);
        }        
        ...
        public RESULT setMeteringEnabled(bool enabled)
        {
            return FMOD_DSP_SetMeteringEnabled(dspraw, enabled ? 1 : 0);
        }

        public RESULT getMeteringEnabled(ref bool enabled)
        {
            int iEnabled = 0;
            RESULT result = FMOD_DSP_GetMeteringEnabled(dspraw, ref iEnabled);
            enabled = iEnabled != 0;
            return result;
        }
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_DSP_SetParameterBool          (IntPtr dsp, int index, int value);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_DSP_GetParameterBool          (IntPtr dsp, int index, out int value, StringBuilder valuestr, int valuestrlen);
        [DllImport(VERSION.dll)]
        ...
        [DllImport(VERSION.dll)]
        public static extern RESULT FMOD_DSP_SetMeteringEnabled         (IntPtr dsp, int enabled);
        [DllImport(VERSION.dll)]
        public static extern RESULT FMOD_DSP_GetMeteringEnabled         (IntPtr dsp, ref int enabled);
        [DllImport(VERSION.dll)]
        public static extern RESULT FMOD_DSP_GetMeteringInfo            (IntPtr dsp, ref DSP_METERING_INFO dspInfo);
        #endregion
